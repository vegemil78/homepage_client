            ...
            <v-col cols="12" md="10">
              <v-card>
                <v-form ref="form" @submit.prevent="onSubmitForm">
                  ...
                  <v-file-input class="inputqq" type="file" counter show-size label="이미지 saaaa제출(여러개 가능)"
                                outlined dense multiple prepend-icon="mdi-camera" style="width: 400px; margin-left: 100px;"/>
                </v-form>
              </v-card>
            </v-col>
  ...
  export default {
    ...
    methods: {
      onImageChange(file) {
        ...
        console.log('kim_kim_kim');
        // axios({
        //   //url: "http://127.0.0.1:52273/content/imagesave/",
        //   url: "https://e2f92c93-299e-41f9-bb9d-5150d25c3d92.mock.pstmn.io/test",
        //   method: "POST",
      ...
      async onSubmitForm(){ 
        if(this.$refs.form.validate()) {
          await axios({ 
            //url: "http://localhost:52273/content/write/",
            url: "https://e2f92c93-299e-41f9-bb9d-5150d25c3d92.mock.pstmn.io/test",
            method: "POST",
            data: {
